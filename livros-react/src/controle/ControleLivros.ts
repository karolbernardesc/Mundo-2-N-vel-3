...
const livros: Array<Livro> = [
    { codigo: 1, codEditora: 1, titulo: 'Use a Cabeça:Java', resumo: 'Use a Cabeça! Java é uma experiência completa de aprendizado em programaçao orientada a objetos (OO) e Java.', autores: ['Bert Bates', 'Kathy Sierra'] },
